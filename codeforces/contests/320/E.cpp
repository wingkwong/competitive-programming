...
struct ConvexHullDynamic {
  ...
  struct Line {
    ...
    double xLeft;  // Stores the intersection wiith previous line in the convex
                   // hull. First line has -INF
  ...
  void addLine(long long a, long long b)  // Add ax + b in logN time
  {
    Line l3 = Line(a, b);
